...
import { CommonSection } from "@/app/components/CommonTags"
import Image from "next/image"

const CaseStudyListingDetail = props => {
    return (
        <>
            <InnerBanner 
                imgSrc='/images/about/inner-banner.webp'
                imgAlt='Casestudy'
                heading='How AI Change The Future'
                subHeading='Lorem Ipsum Dollar Impset'
            />
            
            <CommonSection
                styleClass="case-study-detail"
            >
                <div className="heading">Importance Of Technology</div>
                ...
                <Image src="/images/case-study/casestudy-detail.webp" alt="detail" width={1260} height={493} />
            ...
            <CaseStudyList 
                innerClass="casestudy-listing gradiant-bg"
                heading="Recent casestudies"
...
export default CaseStudyListingDetail